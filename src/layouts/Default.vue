<template>
  <div>
    <header class="my-4 pb-32 relative sm:flex sm:justify-between sm:items-center">
      ...
      <nav :class="isOpen ? 'block' : 'hidden'" class="mt-4 py-3 absolute right-0 px-5 pb-4 sm:flex sm:p-0 sm:m-0">
        <g-link class="block px-2 font-ptsans font-bold hover:underline text-headline hover:text-gray-700" to="/">Blog</g-link>
        <g-link class="mt-6 block px-2 sm:mt-0 sm:ml-2 font-ptsans font-bold hover:underline text-headline hover:text-gray-700" to="/projects/">Projects</g-link>
        <div class="flex justify-between items-center">
          <g-link to="https://twitter.com/piotr_slawinski">
            <svg class="h-5 w-5 mt-6 mx-2 sm:mt-0 sm:ml-2 fill-current text-headline hover:text-gray-700" viewBox="328 355 335 276" xmlns="http://www.w3.org/2000/svg">
          ...
          <g-link to="https://github.com/slawinski">
            <svg class="h-5 w-5 mt-6 mx-2 sm:mt-0 sm:ml-2 fill-current text-headline hover:text-gray-700" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
