  ...
  <div>
    <header class="my-4 pb-32 sm:flex sm:justify-between sm:items-center">
      ...
      <nav :class="isOpen ? 'block' : 'hidden'" class="mt-4 py-3 px-5 pb-4 flex flex-col items-center sm:flex sm:flex-row sm:p-0 sm:m-0">
        <g-link class="block font-ptsans sm:font-bold text-3xl sm:text-base text-headline hover:underline hover:text-gray-700" to="/">Blog</g-link>
        <g-link class="mt-6 sm:mt-0 sm:ml-4 block font-ptsans sm:font-bold text-3xl sm:text-base text-headline hover:underline  hover:text-gray-700" to="/projects/">Projects</g-link>
        <div class="flex justify-between items-center">
          <g-link to="https://twitter.com/piotr_slawinski">
            <svg class="h-10 sm:h-5 w-10 sm:w-5 mt-6 sm:mt-0 mx-2 sm:ml-4 fill-current text-headline hover:text-gray-700" viewBox="328 355 335 276" xmlns="http://www.w3.org/2000/svg">
          ...
          <g-link to="https://github.com/slawinski">
            <svg class="h-10 w-10 sm:h-5 sm:w-5 mt-6 mx-2 sm:mt-0 sm:ml-4 fill-current text-headline hover:text-gray-700" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
